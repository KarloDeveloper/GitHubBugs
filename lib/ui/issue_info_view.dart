                          ...
                          Padding(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(width: 120, child: Text('${snapshot.data?.user?.login}', style: const TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold, height: 1.4),),)
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                const Text('Creation:', style: TextStyle(
                                                    ...
                                                    fontSize: 10)),
                                                Text('${snapshot.data?.creationDate}', style: const TextStyle(
                                                    color: Colors.black,
                        ...
                        child: Padding(
                            ...
                            child:  Column(
                                ...
                                children:[
                                  ...
                                  Center(
                                    child: Text('Last update: ${snapshot.data?.updateDate}', style: const TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.normal, height: 1.4),),
                                  )
                                ]
                            )
                        )
